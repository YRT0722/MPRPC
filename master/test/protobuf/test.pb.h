...
class GetFriendListsResponse :
 ...
 public:
  ...
  // repeated .fixbug.User user = 2;
  int user_size() const;
  private:
  int _internal_user_size() const;
  public:
  void clear_user();
  ::fixbug::User* mutable_user(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
      mutable_user();
  private:
  const ::fixbug::User& _internal_user(int index) const;
  ::fixbug::User* _internal_add_user();
  public:
  const ::fixbug::User& user(int index) const;
  ::fixbug::User* add_user();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User > user_;
  ::fixbug::Resultcode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
inline ::fixbug::User* GetFriendListsResponse::mutable_user(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListsResponse.user)
  return user_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListsResponse::mutable_user() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListsResponse.user)
  return &user_;
}
inline const ::fixbug::User& GetFriendListsResponse::_internal_user(int index) const {
  return user_.Get(index);
}
inline const ::fixbug::User& GetFriendListsResponse::user(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListsResponse.user)
  return _internal_user(index);
}
inline ::fixbug::User* GetFriendListsResponse::_internal_add_user() {
  return user_.Add();
}
inline ::fixbug::User* GetFriendListsResponse::add_user() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListsResponse.user)
...
GetFriendListsResponse::user() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListsResponse.user)
  return user_;
}
